...
def print_Hallo():
    ...
    if(status is True and (len(e1.get()) != 0) and e1.get().isnumeric()):
        ...
        labelasc = tk.Label(root, text="Linked List aufsteigend", bg="#ffffff", fg="black")
        label2 = tk.Label(root, text='{:5.3f}s'.format(lasc), bg="#ffffff", fg="black")
        labeldesc = tk.Label(root, text="Linked List absteigend", bg="#ffffff", fg="black")
        label3 = tk.Label(root, text='{:5.3f}s'.format(ldesc), bg="#ffffff",fg="black")
        labelaasc = tk.Label(root, text="List aufsteigend", bg="#ffffff", fg="black")
        label4 = tk.Label(root, text='{:5.3f}s'.format(aasc), bg="#ffffff", fg="black")
        labeladesc = tk.Label(root, text="List absteigend", bg="#ffffff", fg="black")
        label5 = tk.Label(root, text='{:5.3f}s'.format(adesc), bg="#ffffff", fg="black")
...
label1 = tk.Label(root, text="Eingabe Zahlen", bg="#000000",fg="cyan")
label1.grid(row=0, column=2, padx='5', pady='5', sticky='ew')

root.resizable(width=True, height=True)
schalt1 = tk.Button(root, text="Quit", command=print_Hallo)

e1 = tk.Entry(root)
e1.grid(row=0, column=3)
schalt1.grid(row=2, column=0)
